...
| `log_file` | This file is generated by login.sh. This file stores the information about current session's 16-digit key as well as the details of the network, this is used by the logout script.|
